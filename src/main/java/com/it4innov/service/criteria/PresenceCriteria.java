...
public class PresenceCriteria implements Serializable, Criteria {
    ...
    public PresenceCriteria(PresenceCriteria other) {
        ...
        this.adherantId = other.adherantId == null ? null : other.adherantId.copy();
    ...
    public LongFilter getAdherantId() {
        return adherantId;
    }

    public LongFilter adherantId() {
        if (adherantId == null) {
            adherantId = new LongFilter();
        }
        return adherantId;
    }

    public void setAdherantId(LongFilter adherantId) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(adherantId, that.adherantId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, matriculeAdherant, statutPresence, fichePresenceId, adherantId, distinct);
    }
    ...
    public String toString() {
        return "PresenceCriteria{" +
            ...
            (adherantId != null ? "adherantId=" + adherantId + ", " : "") +
