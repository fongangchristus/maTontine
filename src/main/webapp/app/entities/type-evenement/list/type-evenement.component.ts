...
import { EntityArrayResponseType, TypeEvenementService } from '../service/type-evenement.service';
...
export class TypeEvenementComponent implements OnInit {
  ...
  trackId = (_index: number, item: ITypeEvenement): number => this.typeEvenementService.getTypeEvenementIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.typeEvenements = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ITypeEvenement[] | null): ITypeEvenement[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.typeEvenementService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
