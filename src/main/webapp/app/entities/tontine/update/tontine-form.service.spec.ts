      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            nombrePersonne: expect.any(Object),
            margeBeneficiaire: expect.any(Object),
            montantPart: expect.any(Object),
            montantCagnote: expect.any(Object),
            penaliteRetardCotisation: expect.any(Object),
            typePenalite: expect.any(Object),
            dateCreation: expect.any(Object),
            datePremierTour: expect.any(Object),
            dateDernierTour: expect.any(Object),
