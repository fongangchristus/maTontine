...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../fonction.test-samples';

import { FonctionService } from './fonction.service';

const requireRestSample: IFonction = {
  ...
  describe('Service methods', () => {
    ...
    describe('addFonctionToCollectionIfMissing', () => {
      it('should add a Fonction to an empty array', () => {
        const fonction: IFonction = sampleWithRequiredData;
      ...
      it("should add a Fonction to an array that doesn't contain it", () => {
        const fonction: IFonction = sampleWithRequiredData;
        const fonctionCollection: IFonction[] = [sampleWithPartialData];
        expectedResult = service.addFonctionToCollectionIfMissing(fonctionCollection, fonction);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(fonction);
      });
      ...
      it('should add only unique Fonction to an array', () => {
        const fonctionArray: IFonction[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const fonctionCollection: IFonction[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const fonction: IFonction = sampleWithRequiredData;
        const fonction2: IFonction = sampleWithPartialData;
    ...
    describe('compareFonction', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareFonction(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareFonction(entity1, entity2);
        const compareResult2 = service.compareFonction(entity2, entity1);
