...
describe('Document e2e test', () => {
  ...
  describe('Document page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit Document page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Document');
  ...
  describe('new Document page', () => {
    ...
    it('should create an instance of Document', () => {
      cy.get(`[data-cy="libelle"]`).type('Books Handcrafted copying').should('have.value', 'Books Handcrafted copying');

      cy.get(`[data-cy="docKey"]`).type('ivory networks').should('have.value', 'ivory networks');

      cy.get(`[data-cy="path"]`).type('SAS Rubber').should('have.value', 'SAS Rubber');

      cy.get(`[data-cy="typeDocument"]`).type('bus cohesive solid').should('have.value', 'bus cohesive solid');
