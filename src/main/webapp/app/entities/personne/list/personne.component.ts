...
export class PersonneComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPersonne): number => this.personneService.getPersonneIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.personnes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPersonne[] | null): IPersonne[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.personneService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
