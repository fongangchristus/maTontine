...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../banque.test-samples';

import { BanqueService, RestBanque } from './banque.service';

const requireRestSample: RestBanque = {
  ...sampleWithRequiredData,
  dateOuverture: sampleWithRequiredData.dateOuverture?.toJSON(),
