...
type DocumentFormGroupContent = {
  ...
  libelle: FormControl<IDocument['libelle']>;
  docKey: FormControl<IDocument['docKey']>;
  path: FormControl<IDocument['path']>;
...
export class DocumentFormService {
  createDocumentFormGroup(document: DocumentFormGroupInput = { id: null }): DocumentFormGroup {
    ...
    return new FormGroup<DocumentFormGroupContent>({
      ...
      libelle: new FormControl(documentRawValue.libelle),
      docKey: new FormControl(documentRawValue.docKey),
      path: new FormControl(documentRawValue.path),
