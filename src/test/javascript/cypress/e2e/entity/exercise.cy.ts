...
describe('Exercise e2e test', () => {
  ...
  describe('Exercise page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit Exercise page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Exercise');
  ...
  describe('new Exercise page', () => {
    ...
    it('should create an instance of Exercise', () => {
      cy.get(`[data-cy="libele"]`).type('c').should('have.value', 'c');

      cy.get(`[data-cy="observation"]`).type('Buckinghamshire Garden').should('have.value', 'Buckinghamshire Garden');
      ...
      cy.get(`[data-cy="statut"]`).select('FERME');
