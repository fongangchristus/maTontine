...
describe('Adhesion Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'adhesion', component: AdhesionComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to adhesionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAdhesionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAdhesionIdentifier).toHaveBeenCalledWith(entity);
