...
type PaiementFormGroupContent = {
  ...
  codeAssociation: FormControl<PaiementFormRawValue['codeAssociation']>;
  referencePaiement: FormControl<PaiementFormRawValue['referencePaiement']>;
  matriculecmptEmet: FormControl<PaiementFormRawValue['matriculecmptEmet']>;
  matriculecmptDest: FormControl<PaiementFormRawValue['matriculecmptDest']>;
  montantPaiement: FormControl<PaiementFormRawValue['montantPaiement']>;
  datePaiement: FormControl<PaiementFormRawValue['datePaiement']>;
  modePaiement: FormControl<PaiementFormRawValue['modePaiement']>;
...
export class PaiementFormService {
  createPaiementFormGroup(paiement: PaiementFormGroupInput = { id: null }): PaiementFormGroup {
    ...
    return new FormGroup<PaiementFormGroupContent>({
      ...
      codeAssociation: new FormControl(paiementRawValue.codeAssociation, {
        validators: [Validators.required],
      }),
      referencePaiement: new FormControl(paiementRawValue.referencePaiement),
      matriculecmptEmet: new FormControl(paiementRawValue.matriculecmptEmet, {
        validators: [Validators.required],
      }),
      matriculecmptDest: new FormControl(paiementRawValue.matriculecmptDest, {
        validators: [Validators.required],
      }),
      montantPaiement: new FormControl(paiementRawValue.montantPaiement, {
        validators: [Validators.required],
      }),
