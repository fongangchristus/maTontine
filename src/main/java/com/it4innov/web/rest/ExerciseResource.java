...
import com.it4innov.service.ExerciseQueryService;
...
/**
 * REST controller for managing {@link com.it4innov.domain.Exercise}.
 */
@RestController
@RequestMapping("/api")
public class ExerciseResource {
    ...
    public ResponseEntity<ExerciseDTO> updateExercise(
        ...
        ExerciseDTO result = exerciseService.update(exerciseDTO);
        return ResponseEntity
            .ok()
