...
describe('Banque Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'banque', component: BanqueComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to banqueService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getBanqueIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getBanqueIdentifier).toHaveBeenCalledWith(entity);
