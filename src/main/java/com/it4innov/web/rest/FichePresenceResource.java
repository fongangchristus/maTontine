...
public class FichePresenceResource {
    ...
    public ResponseEntity<FichePresenceDTO> createFichePresence(@RequestBody FichePresenceDTO fichePresenceDTO) throws URISyntaxException {
    ...
    public ResponseEntity<FichePresenceDTO> updateFichePresence(
        ...
        @RequestBody FichePresenceDTO fichePresenceDTO
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, fichePresenceDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/fiche-presences/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<FichePresenceDTO> partialUpdateFichePresence(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, fichePresenceDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<FichePresenceDTO> getFichePresence(@PathVariable Long id) {
